    ...
    <div className='footer' id='footer'>
       <div className="footer-content">
        <div className="footer-content-left">
          <h1> <a>Fusion</a> Hub</h1>
            {/* <img src={assets.logo} alt="" /> */}
            <p>

            Welcome to Fusion Hub, your one-stop destination for seamless online shopping. We offer a wide range of products and services, including food delivery, clothing, and books, all integrated into a single platform for your convenience.
